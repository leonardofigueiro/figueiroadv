...
/**
 * Página de referência do Design System (dev/QA).
 * noindex — não deve ser indexada; remover ou proteger antes do launch.
 */
export default function StyleGuide() {
  return (
    <>
      <Head>
        <title>Design System | Figueiró Advocacia</title>
